...
import { Mail, Lock, Loader2, AlertCircle, ArrowUpRight } from "lucide-react";
...
const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
  ...
  return (
    <div className="min-h-screen w-full flex bg-[#EDEAE2]">
      ...
      {/* Left dark panel — like the photo cards in the reference */}
      <div className="hidden lg:flex lg:w-[45%] p-6">
        <div className="relative w-full rounded-3xl bg-[#111111] overflow-hidden flex flex-col justify-between p-8">
          ...
          {/* Signature board preview, centered */}
          ...
          {/* Bottom caption row, arrow button — matching reference style */}
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          >
            Welcome back,{" "}
            <span className="italic text-[#6B6B6B]">SyncBoard</span>
          </h1>
          <p className="text-[#6B6B6B] mb-9">
            Your boards, your team, right where you left off.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label htmlFor="password" className="block text-xs uppercase tracking-wider text-[#6B6B6B]">
                  Password
                </label>
                <a href="/forgot-password" className="text-xs text-[#1A1A1A] underline underline-offset-2">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
          ...
          <p className="text-[#6B6B6B] text-center mt-7">
            ...
            <a href="/register" className="text-[#1A1A1A] underline underline-offset-2">
              Sign up
            </a>
          </p>
        </div>
